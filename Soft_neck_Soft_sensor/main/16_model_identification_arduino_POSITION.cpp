...
//    target_pitch.insert(target_pitch.end(), target0.begin(), target0.end());
//    std::vector<double> target1;
//    referenceStep(target1, dts, 0.174533, 1.0); //STEP->(std::vector<double>& pitch, double dt, double amplitude, double duration)
//    target_pitch.insert(target_pitch.end(), target1.begin(), target1.end());
//    std::vector<double> target2;
//    referenceStep(target2, dts, -0.174533, 1.0); //STEP->(std::vector<double>& pitch, double dt, double amplitude, double duration)
//    target_pitch.insert(target_pitch.end(), target2.begin(), target2.end());
//    std::vector<double> target3;
//    referenceStep(target3, dts, 0.174533, 1.0); //STEP->(std::vector<double>& pitch, double dt, double amplitude, double duration)
//    target_pitch.insert(target_pitch.end(), target3.begin(), target3.end());
//    std::vector<double> target4;
//    referenceStep(target4, dts, -0.174533, 1.0); //STEP->(std::vector<double>& pitch, double dt, double amplitude, double duration)
//    target_pitch.insert(target_pitch.end(), target4.begin(), target4.end());
//    std::vector<double> target5;
//    referenceStep(target5, dts, 0.174533, 1.0); //STEP->(std::vector<double>& pitch, double dt, double amplitude, double duration)
//    target_pitch.insert(target_pitch.end(), target5.begin(), target5.end());
//    std::vector<double> target6;
//    referenceStep(target6, dts, -0.174533, 1.0); //STEP->(std::vector<double>& pitch, double dt, double amplitude, double duration)
//    target_pitch.insert(target_pitch.end(), target6.begin(), target6.end());
//    std::vector<double> target7;
//    referenceStep(target7, dts, 0.174533, 1.0); //STEP->(std::vector<double>& pitch, double dt, double amplitude, double duration)
//    target_pitch.insert(target_pitch.end(), target7.begin(), target7.end());
//    std::vector<double> target8;
//    referenceStep(target8, dts, -0.174533, 1.0); //STEP->(std::vector<double>& pitch, double dt, double amplitude, double duration)
//    target_pitch.insert(target_pitch.end(), target8.begin(), target8.end());
//    std::vector<double> target9;
//    referenceStep(target9, dts, 0.174533, 1.0); //STEP->(std::vector<double>& pitch, double dt, double amplitude, double duration)
//    target_pitch.insert(target_pitch.end(), target9.begin(), target9.end());
//    std::vector<double> target10;
//    referenceStep(target10, dts, -0.174533, 1.0); //STEP->(std::vector<double>& pitch, double dt, double amplitude, double duration)
