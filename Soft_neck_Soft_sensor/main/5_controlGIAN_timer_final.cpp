...
//    target_pitch.insert(target_pitch.end(), target3.begin(), target3.end());
    ...
    for(int index=0; index<size; index++){
        ...
        target_rpy[index][0]=target_roll[index];
