...
void multimeterThreadFunction(SerialComm* serial, std::vector<double>& data_resistance, double dt, int size) {
...
void referenceStep(std::vector<double>& pitch, double dt, double amplitude, double duration){
    //STEP-------------------------------------------------------------------------
...
void referenceRamp(std::vector<double>& pitch, double dt, double amplitude, double rate){
     //RAMP--------------------------------------------------------------------------
...
void referenceDoubleRamp(std::vector<double>& pitch, double dt, double amplitude, double rate){
     //DOUBLE RAMP--------------------------------------------------------------------------
...
void referenceCyclicRamp(std::vector<double>& pitch, double dt, double amplitude, double rate, int nCycles){
    //DOUBLE RAMP--------------------------------------------------------------------------
    double period = 2 * 1/rate;
...
int main()
{
    ...
    IMU3DMGX510 misensor("/dev/ttyUSB0",freq);  // IMU port selection (portName,frequency)ººººººººººº
    ...
    //--Control---------------------------------------
    std::thread multimeterThread(multimeterThreadFunction, serial, std::ref(data_resistance), dts, size);
